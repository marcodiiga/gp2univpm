...
public class SplineController : MonoBehaviour
{
	...
	void FollowSpline()
	{
		if (mTransforms.Length > 0)
		{
			...
			mSplineInterp.StartInterpolation(endCallBack, true, WrapMode);
		}
	}

	public GameObject cpuProgram;
	public GameObject gpuProgram;

	void endCallBack() {
		cpuProgram.GetComponent<SplineControllerCPU>().FollowSpline();
		gpuProgram.GetComponent<SplineControllerBreak>().FollowSpline();
	}
}